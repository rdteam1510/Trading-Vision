...
df = pd.read_csv('HSX.csv',  header=0, parse_dates=['<DTYYYYMMDD>'], squeeze=True, date_parser=parser, usecols=col_lists)
#Get ticker AIC
ticker = "ACB"
...
newindex = np.asarray(pd.RangeIndex(start=x[-1], stop=x[-1] + 100))
